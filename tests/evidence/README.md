...
**149項目のうち144項目をこの道具で撮れる。** 残りは次の5項目。

| 項目 | この道具で撮れない理由 |
|---|---|
| 3-4-1〜3-4-4 | QR の読み取り。カメラと**2台目の実機**が要る（**2026-07-31 に実機で撮影済み**。撮り直すときも手で撮る） |
...
node tests/evidence/capture.mjs                 # 撮れる144項目すべて（30分ほどかかる）
